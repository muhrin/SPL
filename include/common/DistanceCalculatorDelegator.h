...
public:
  ...
  { return myDelegate->getDistsBetween(a, b, cutoff, outDistances, maxDistances, maxCellMultiples); }
  ...
  virtual inline bool getDistsBetween(
    ...
    const size_t maxDistances = DEFAULT_MAX_OUTPUTS,
    const unsigned int maxCellMultiples = DEFAULT_MAX_CELL_MULTIPLES) const
  { return myDelegate->getDistsBetween(atom1, atom2, cutoff, outDistances, maxDistances, maxCellMultiples); }
  ...
  virtual bool getVecsBetween(
    ...
    const unsigned int maxCellMultiples = DEFAULT_MAX_CELL_MULTIPLES) const
  { return myDelegate->getVecsBetween(a, b, cutoff, outVectors, maxVectors, maxCellMultiples); }
  ...
  virtual bool getVecsBetween(
    ...
    const size_t maxVectors = DEFAULT_MAX_OUTPUTS,
    const unsigned int maxCellMultiples = DEFAULT_MAX_CELL_MULTIPLES) const
  { return myDelegate->getVecsBetween(atom1, atom2, cutoff, outVectors, maxVectors, maxCellMultiples); }
