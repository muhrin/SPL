...
public:
  ...
  virtual TersoffPotentialData<FloatType> *
    generatePotentialData(const spl::common::Structure & structure) const;
...
TersoffPotential<FloatType>::generatePotentialData(const spl::common::Structure & structure) const
{
