...
void StructureWriterManager::registerReader(IStructureReader & reader)
{
...
void StructureWriterManager::deregisterReader(IStructureReader & reader)
{
...
common::types::StructurePtr StructureWriterManager::readStructure(
  const ResourceLocator & locator,
...
size_t StructureWriterManager::readStructures(
...
bool StructureWriterManager::getExtension(::std::string & ext, const ResourceLocator & locator) const
{
	// Get the extension
